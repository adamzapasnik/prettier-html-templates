...
function isTextLikeNode(node) {
  // TODO: verify if we need this ( I think we do for the e<% longlong %>e expressions)
  return node.type === "text" || node.type === "comment" || node.type === "expression" && node.expressionType === "plain"; 
}
