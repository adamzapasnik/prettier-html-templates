...
var line = prettier.doc.builders.line;
var PLACEHOLDER_REGEX = /<eext\d+/;
export var isSelfClosingInText = function (parts) {
    if (parts.length !== 2)
        return;
...
export var decodeSelfClosingInText = function (parts, expressionMap) {
    var decodedParts = [];
...
export var isSelfClosingAfterOpenTag = function (part) {
    if (part.type === 'group' &&
        part.contents &&
