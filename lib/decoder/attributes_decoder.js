...
exports.decodeInAttributes = exports.isInElement = void 0;
var prettier_1 = __importDefault(require("prettier"));
var _a = prettier_1.default.doc.builders, indent = _a.indent, hardline = _a.hardline, group = _a.group;
var isInElement = function (parts) { return parts.some(function (part) { return typeof part === 'string' && part.match(/eex[a|c]?\d+/); }); };
exports.isInElement = isInElement;
var decodeInAttributes = function (parts, expressionMap) {
...
exports.decodeInAttributes = decodeInAttributes;
